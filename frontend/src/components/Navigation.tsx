...
export default function Navigation() {
  ...
  return (
    <nav className={cn(
      'py-3 border-b border-[#2C2E39] z-30 pointer-events-auto glass',
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between">
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? 'font-semibold text-white border-b-2 border-[#5CE5A0] bg-white/10'
                      : 'font-normal text-[#F5F5F7]/70 hover:text-[#5DDFFF] hover:bg-white/5'
                  )}
                >
                  <Icon size={14} />
                  {item.label}
          ...
          <div className="relative" ref={menuRef}>
            ...
            {menuOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-[#1B1E27] border border-[#2C2E39] rounded-xl shadow-xl py-1 z-50">
